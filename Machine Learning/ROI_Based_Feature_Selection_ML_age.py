...
GROUPING_BENCHMARK_CSV = "grouping_tier_vs_lasso_benchmark.csv"
RUN_MULTI_SEED_STABILITY = True
MULTI_SEED_N_SEEDS = 5
SAVE_PLOTS_ONLY = True
STABILITY_THRESHOLD = 0.8
STABLE_FEATURES_CSV = "selected_features_stable_cv.csv"
PARTICIPANT_PREDICTION_ERRORS_CSV = "participant_prediction_errors.csv"
RUN_CPSS = True

DEFAULT_DATA_PATH = (
    "/Users/alpmac/CodeWorks/Trento/Dortmund_Vital_Alp_Akova_Clean/Data/merged_df_connectivity_power.csv"
)
